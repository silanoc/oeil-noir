...
class Test_generateur_perso():
    ...
    def test_chercher_les_choix_possibles(self):
        ...
        possible.sort()
        assert possible == ["aventurier", "elfe", "guerrier", "magicien", "nain"]
    ...
    def test_defini_au_hasard_la_classe(self):
        ...
        perso3.defini_au_hasard_la_classe(["aventurier", "elfe", "guerrier", "magicien", "nain"])
        assert perso3.classe_metier in ["aventurier", "elfe", "guerrier", "magicien", "nain"] 
